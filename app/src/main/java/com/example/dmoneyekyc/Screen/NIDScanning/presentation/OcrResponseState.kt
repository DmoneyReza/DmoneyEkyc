...
data class OcrResponseState(
    val response: OCRespondsModel = OCRespondsModel(successMessage = null, errorMessage = null, data = listOf(
        OCRData(nidName = null, nidNumber = null, nidDob = null, extractedString = null)
    )),
